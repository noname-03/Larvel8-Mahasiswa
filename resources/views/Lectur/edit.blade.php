...
<form action="{{ route('lectur.update', ['lectur'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf @method('PATCH')
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="inputPassword4">Nidn</label>
        <input type="text" name="nidn" class="form-control" value="{{$data->nidn}}" id="inputPassword4">
    </div>
        <div class="form-group col-md-6">
